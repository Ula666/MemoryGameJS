...
//Resetting variable that should be reset if you click play or reset game. A shallow var reset
function reset_var_shallow(){
    //reseting the last color clicked, amount of clicks, clicked tiles, duplicate tiles var
    last_color = "",
        click = '0',
        clicked_tiles = [],
...
// Reseting variables associated with the randomization of tiles placement. this is a deep reset
function reset_var_deep(){
    //used for loop checking how many of each color is chosen
    var red = 0,
        blue = 0,
        yellow = 0,
        purple = 0,
    ...
    //empty the arrays to store tiles
    red_array = [],
        blue_array = [],
        yellow_array = [],
        purple_array = [],
...
//onload function, getting the game ready when the web pag has loaded
window.onload = function(){
    reset_var_deep();

    console.log("onload function is completed")
}

//Clicking play you can try again, tiles have same placement
function start_game(){
    //this fynction is used to start game and reset game
    reset_var_shallow();
...
//Completely reset the game, changing placement of tiles
function reset_game(){
    //this fynction is used to start game and reset game
    reset_var_shallow();
